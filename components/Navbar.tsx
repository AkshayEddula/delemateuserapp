  ...
  return (
    <nav className="w-full bg-[#fafafa] sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="backdrop-blur-md bg-white/80 border border-white/20 rounded-2xl shadow-lg">
          <div className="px-6 py-3 flex items-center justify-between">
            {/* Logo */}
            <Link href="/" className="text-[#133bb7] font-bold text-2xl tracking-tight">
              Delemate
            </Link>

            {/* Navigation Links - Desktop Only */}
            <div className="hidden md:flex items-center gap-8">
              <Link href="/orders" className="text-gray-600 hover:text-[#133bb7] font-medium transition-colors">
                Orders
              </Link>
            </div>
          ...
          {!user ? (
            <Link
              href="/login"
              className="px-6 py-3 bg-[#133bb7] text-white rounded-xl font-semibold hover:bg-[#0f2a8a] transition-all duration-200 shadow-sm hover:shadow-md"
            >
              Login
            </Link>
          ) : (
            <div className="flex items-center gap-3 relative">
              ...
              <button className="relative p-2 text-gray-600 hover:text-[#133bb7] transition-colors">
              ...
              <div className="hidden md:flex items-center gap-3 relative">
                ...
                >
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#133bb7] to-[#3b5bc7] text-white flex items-center justify-center font-semibold text-sm">
                  {user.name
                ...
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={`transition-transform ${open ? 'rotate-180' : ''}`}>
                ...
                {/* Dropdown */}
              {open && (
                <div className="absolute right-0 mt-2 w-64 backdrop-blur-md bg-white/90 border border-white/20 rounded-2xl shadow-xl py-2 z-50">
                  ...
                  <div className="py-2">
                    ...
                    <Link href="/orders" className="flex items-center gap-3 px-4 py-3 hover:bg-gray-50 transition-colors">
                      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <Link href="/settings" className="flex items-center gap-3 px-4 py-3 hover:bg-gray-50 transition-colors">
                      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
