...
export default function Navbar() {
  ...
  return (
    <nav className="w-full sticky top-0 bg-[#fafafa] z-50">
      <div className="max-w-7xl mx-auto  bg-[#fafafa] px-4 sm:px-6 lg:px-8 py-3">
        <div className="backdrop-blur-xl bg-white/90 border border-gray-200 rounded-2xl shadow-lg">
          <div className="px-4 py-2 flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-6">
              <Link href="/orders" className="text-[#133bb7]/70 hover:text-[#133bb7] font-medium transition-colors text-sm">
                Orders
              </Link>
            </div>
            ...
            <div className="flex items-center gap-3 relative">
              {!user ? (
                <Link
                  href="/login"
                  className="px-4 py-2 bg-white/20 backdrop-blur-sm text-[#133bb7] rounded-xl font-semibold hover:bg-white/30 transition-all duration-200 text-sm border border-white/20"
                >
                  Login
                </Link>
              ) : (
                <div className="flex items-center gap-2 relative">
                  ...
                  <button className="relative p-2 text-[#133bb7]/70 hover:text-[#133bb7] transition-colors">
                  ...
                  <div className="hidden md:flex items-center gap-2 relative">
                    <div
                      className="flex items-center gap-2 cursor-pointer hover:bg-white/10 rounded-xl p-1 transition-colors"
                      onClick={() => setOpen(!open)}
                    >
                      <div className="w-8 h-8 rounded-full bg-[#133bb7]/10 backdrop-blur-sm text-[#133bb7] flex items-center justify-center font-semibold text-xs border border-white/30">
                        {user.name
                          ? user.name.charAt(0).toUpperCase()
                          : user.phone?.slice(-2)}
                      </div>
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={`transition-transform text-[#133bb7]/70 ${open ? 'rotate-180' : ''}`}>
                    ...
                    {/* Dropdown */}
                    {open && (
                      <div className="absolute right-0 mt-2 w-56 backdrop-blur-xl bg-white/90 border border-white/20 rounded-2xl shadow-xl py-2 z-50">
                        ...
                        <div className="py-2">
                          ...
                          <Link href="/orders" className="flex items-center gap-3 px-4 py-2 hover:bg-gray-50 transition-colors">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span className="text-gray-700 text-sm">My Orders</span>
                          </Link>
                          <Link href="/profile" className="flex items-center gap-3 px-4 py-2 hover:bg-gray-50 transition-colors">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
